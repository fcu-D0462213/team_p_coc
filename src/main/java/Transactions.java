...
//
//        orderTransaction = new main.java.OrderTransaction(session);
//        paymentTransaction = new main.java.PaymentTransaction(session);
//        deliveryTransaction = new main.java.DeliveryTransaction(session);
//        orderStatusTransaction = new main.java.OrderStatusTransaction(session);
//        stockLevelTransaction = new main.java.StockLevelTransaction(session);
//        popularItemTransaction = new main.java.PopularItemTransaction(session) ;
//        topBalanceTransaction = new main.java.TopBalanceTransaction(session);
//    }
//
