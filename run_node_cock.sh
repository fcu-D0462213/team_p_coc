...
# bash run_node_cock.sh /temp/team_p/project-files/xact-files <node_id> <n_clients> <True/False> <QUORUM/ONE>
# E.g.
# bash run_node_cock.sh /temp/team_p/project-files/xact-files 1 10 False QUORUM
